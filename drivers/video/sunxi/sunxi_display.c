...
static uint8_t readID(void) {
   ...
   // force configuration from SD in console.cfg
    if (console_variant && !strcmp(console_variant, "bittboy2x_v1")) {
        ...
        env_set("bootcmd_args", "setenv bootargs console=tty0 console=ttyS1,115200 panic=5 rootwait root=/dev/mmcblk0p2 rw miyoo_kbd.miyoo_ver=1 miyoo_kbd.miyoo_layout=3 miyoo.miyoo_snd=1 miyoo_vir.motor_ver=1");
        writeScreenReg = 0x2c;
        madctlCmd = 0xe0;
        invert = 0x20;
        return 1;
    ...
    if (console_variant && !strcmp(console_variant, "bittboy2x_v2")) {
        ...
        env_set("bootcmd_args", "setenv bootargs console=tty0 console=ttyS1,115200 panic=5 rootwait root=/dev/mmcblk0p2 rw miyoo_kbd.miyoo_ver=1 miyoo_kbd.miyoo_layout=3 miyoo.miyoo_snd=1 miyoo_vir.motor_ver=2");
        writeScreenReg = 0x2c;
        madctlCmd = 0x70;
        invert = 0x20;
        return 2;
    ...
    if (console_variant && !strcmp(console_variant, "bittboy3.5")) {
        ...
        env_set("bootcmd_args", "setenv bootargs console=tty0 console=ttyS1,115200 panic=5 rootwait root=/dev/mmcblk0p2 rw miyoo_kbd.miyoo_ver=7 miyoo_kbd.miyoo_layout=3 miyoo.miyoo_snd=1 miyoo_vir.motor_ver=2");
        writeScreenReg = 0x2c;
        madctlCmd = 0x70;
        invert = 0x20;
        return 2;
    ...
    if (console_variant && !strcmp(console_variant, "pocketgo")) {
        ...
        env_set("bootcmd_args", "setenv bootargs console=tty0 console=ttyS1,115200 panic=5 rootwait root=/dev/mmcblk0p2 rw miyoo_kbd.miyoo_ver=2 miyoo_kbd.miyoo_layout=1 miyoo.miyoo_snd=1 miyoo_vir.motor_ver=2");
        writeScreenReg = 0x2c;
        madctlCmd = 0xB0;
        invert = 0x20;
        return 2;
    ...
    if (console_variant && (!strcmp(console_variant, "q20") || !strcmp(console_variant, "q90"))) {
        ...
        env_set("bootcmd_args", "setenv bootargs console=tty0 console=ttyS1,115200 panic=5 rootwait root=/dev/mmcblk0p2 rw miyoo_kbd.miyoo_ver=6 miyoo_kbd.miyoo_layout=1 miyoo.miyoo_snd=1 miyoo_vir.motor_ver=2");
        writeScreenReg = 0x2c;
        madctlCmd = 0xB0;
        invert = 0x20;
        return 2;
    ...
    if (console_variant && !strcmp(console_variant, "v90")) {
        ...
        env_set("bootcmd_args", "setenv bootargs console=tty0 console=ttyS1,115200 panic=5 rootwait root=/dev/mmcblk0p2 rw miyoo_kbd.miyoo_ver=5 miyoo_kbd.miyoo_layout=1 miyoo.miyoo_snd=1 miyoo_vir.motor_ver=2");
        writeScreenReg = 0x2c;
        madctlCmd = 0xB0;
        invert = 0x20;
        return 2;
   ...
   // Autodetection method if no valid CONSOLE_VARIANT provided within cnofiguration file in SD
    ...
    if ((ver[1] == 0x22) && (ver[2] == 0x15) && (ver[3] == 0x20)) { // R61520 controller
        ...
        env_set("bootcmd_args", "setenv bootargs console=tty0 console=ttyS1,115200 panic=5 rootwait root=/dev/mmcblk0p2 rw miyoo_kbd.miyoo_ver=1 miyoo_kbd.miyoo_layout=1 miyoo.miyoo_snd=1 miyoo_vir.motor_ver=1");
        madctlCmd = 0xe0;
        invert = 0x20;
        writeScreenReg = 0x2c;
        return 1;
